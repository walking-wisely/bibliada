---
title: App Store Review Guidelines (local reference copy)
source: https://developer.apple.com/app-store/review/guidelines/
retrieved: 2026-08-01
note: |
  Verbatim text extracted from Apple's published page and converted to Markdown.
  Section numbering (1.1.5, 2.3.7, 4.2, 5.2.2, ...) is preserved inline in bold at the
  start of each rule. Apple revises this document without notice - re-fetch before
  each submission. This copy is for offline checklist use only; the authoritative
  text is at the source URL above.
---
...
- **2.5.6** Apps that browse the web must use the appropriate WebKit framework and WebKit JavaScript. You may apply for an entitlement to use an alternative web browser engine in your app. Learn more about these entitlements for the EU and Japan.
